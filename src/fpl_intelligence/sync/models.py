...
class SyncLivePointDB(Base):
    ...
    __table_args__ = (UniqueConstraint("gameweek", "element_id", name="uq_sync_live_gw_element"),)
...
class IngestedGameweekDB(Base):
    ...
    __table_args__ = (UniqueConstraint("gameweek", "element_id", name="uq_ingested_gw_element"),)
...
class PredictionLedgerDB(Base):
    ...
    __table_args__ = (UniqueConstraint("gameweek", "element_id", name="uq_pred_ledger_gw_element"),)
