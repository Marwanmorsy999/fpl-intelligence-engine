/* v2.5.4-sync-fallback — FPL squad-push bookmarklet (source form).
   The /connect page wraps this file's body into a javascript: URL.
   v2.5.4 CSP fallback: entire execution is wrapped in try/catch and a 3s
...
var BOOKMARKLET_VERSION = "2.5.4-sync-fallback";
(function () {
  "use strict";
