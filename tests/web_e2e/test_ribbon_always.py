...
DECISIONS_MIN = {
    ...
    "meta": {
        ...
        "chain": {"source_label": "p", "data_quality": "ok"},
    },
}
...
def _mocked(page: Page) -> Iterator[Page]:
    ...
    page.route(
        "**/api/v1/players**", _json_route([{"id": 1, "fpl_element_id": 1, "web_name": "Areola"}])
    )
...
class TestRibbonAlwaysVisible:
    def test_dashboard_ribbon_visible_no_session_disabled_hint(self, _mocked: Page):
        ...
        expect(hint).to_contain_text("Analyze your team to enable Refresh Rivals")
    ...
    def test_connect_ribbon_visible_demo_and_fpl_id(self, _mocked: Page):
        ...
        expect(page.locator('[data-testid="sync-ribbon-hint"]')).to_contain_text(
            "Analyze your team to enable Refresh Rivals"
        )
        # fpl_id on /connect
        sess_real = {
            "key": "794561",
