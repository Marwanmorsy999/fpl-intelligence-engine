...
def test_methods_produce_distinct_strength_and_fixture_signatures_on_controlled_history() -> None:
    ...
    # Distinct strength estimators may legitimately converge to the same
    # downstream fixture probabilities. The controlled-history regression
    # therefore requires fixture diversity, not a one-to-one mapping.
